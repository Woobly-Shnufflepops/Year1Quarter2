...
namespace MySecondClassExample
{
    class BankAccount
    {
       ...
       static BankAccount()
        ...
        public BankAccount()
            : this("Unknown", 9999999, 0.0m)
            // call the parametrized constructor with the
            // default values to eliminate code redundancy
            // avoid duplicating what the main constructor
            // code does
        {
            //this._name = "Unknown";
            //this.AccountNumber = 99999999;
            //this.Balance = 0.0m;
            //++Count;
            // bogus new BankAccount("Unknown", 9999999, 0.0m);
        }
